...
const GrossReceiptReturn: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    nonPreparedFoodBeverageReceipts: existingData.nonPreparedFoodBeverageReceipts || ''
  });
    ...
    navigate('/gross-receipt-bills/final-review', {
      state: {
        returnData: {
          ...formData,
          account: '4',
          returnType: 'GR Food and Beverage',
          ownerName: 'JENS BAKERY',
          ownerAddress: '123 SUGAR WAY PITTSBORO NC 27312',
          ...
          locations: [
            {
              ...
              nonPreparedReceipts: formData.nonPreparedFoodBeverageReceipts || '0.00'
            }
          ]
        }
      }
            ...
            <form onSubmit={(e) => { e.preventDefault(); handleGoToFinalReview(); }}>
              ...
              <section className="mb-8">
                ...
                <div className="grid grid-cols-1 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className="ml-2">JENS BAKERY</span>
                  </div>
                  <div>
                    <span className="font-medium text-gray-700">Owner Address:</span>
                    <span className="ml-2">123 SUGAR WAY PITTSBORO NC 27312</span>
                  </div>
                  <div>
                    <span className="font-medium text-gray-700">Account Type:</span>
                    <span className="ml-2">GR Food and Beverage</span>
                  </div>
                  <div>
                  ...
                  <table className="w-full border-collapse border border-gray-300">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border border-gray-300 px-4 py-2 text-sm">SUGAR HWYO</td>
              ...
              <section className="mb-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <label htmlFor="non-prepared-food" className="block text-sm font-medium text-gray-700 mb-2 bg-gray-100 p-2 rounded">
                      Non-Prepared Food/Beverage Receipts $
                    </label>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">$</span>
                      <input
                        id="non-prepared-food"
                        type="number"
                        step="0.01"
                        min="0"
                        value={formData.nonPreparedFoodBeverageReceipts}
                        onChange={(e) => handleInputChange('nonPreparedFoodBeverageReceipts', e.target.value)}
                        className="w-full pl-8 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#002B5B] focus:border-[#002B5B] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                        aria-describedby="non-prepared-help"
                      />
                    </div>
                    <p id="non-prepared-help" className="text-xs text-gray-600 mt-1">Enter amount in dollars and cents</p>
                  </div>
                </div>
              </section>
...
export default GrossReceiptReturn;