...
const CountyAdmin: React.FC = () => {
  ...
  return (
    <main className="min-h-[calc(100vh-8rem)]" role="main">
      ...
      <h1 className="text-3xl font-semibold text-gray-800 mb-8" id="main-heading">County Admin Dashboard</h1>
      
      <section className="bg-white rounded-lg shadow-md p-6" aria-labelledby="main-heading">
        <p className="text-gray-600 mb-6">Welcome to the County Admin Dashboard</p>
        ...
        <div className="space-y-6" role="region" aria-label="Configuration options">
          ...
          <p className="text-gray-600 mb-6">
            County Admin can configure it's county by performing below actions:
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6" role="list">
            ...
            <article className="p-4 border border-gray-200 rounded-lg" role="listitem">
              ...
              <p className="text-gray-600">Set up and manage county-specific configurations and preferences. County admin should be able to use SSO (Single Sign On) to login.</p>
            </article>
          </div>
        </div>
      </section>
