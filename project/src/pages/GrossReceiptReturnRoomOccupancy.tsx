...
const GrossReceiptReturnRoomOccupancy: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    grossRetailReceipts: existingData.grossRetailReceipts || '',
    extendedStays: existingData.extendedStays || '',
    governmentExemptions: existingData.governmentExemptions || '',
    nonOccupancy: existingData.nonOccupancy || ''
  });
    ...
    navigate('/gross-receipt-bills/final-review', {
      state: {
        returnData: {
          ...formData,
          account: '23',
          returnType: 'GR Room Occupancy',
          ownerName: 'JENS HOTEL',
          ownerAddress: '123 SLEEPY LANE PITTSBORO NC 27312',
          ...
          locations: [
            {
              name: '1',
              address: '234 TEST ST',
              receipts: formData.grossRetailReceipts || '0.00',
              extendedStays: formData.extendedStays || '0.00',
              governmentExemptions: formData.governmentExemptions || '0.00',
              nonOccupancy: formData.nonOccupancy || '0.00'
            }
          ]
        }
      }
          ...
          <main>
            <form onSubmit={(e) => { e.preventDefault(); handleGoToFinalReview(); }}>
              ...
              <section className="mb-8" aria-labelledby="account-info-heading">
                ...
                <div className="grid grid-cols-1 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <span className="ml-2">JENS HOTEL</span>
                  </div>
                  <div>
                    <span className="font-medium text-gray-700">Owner Address:</span>
                    <span className="ml-2">123 SLEEPY LANE PITTSBORO NC 27312</span>
                  </div>
                  <div>
                    <span className="font-medium text-gray-700">Account Type:</span>
                    <span className="ml-2">GR Room Occupancy</span>
                  </div>
                  <div>
                  ...
                  <table className="w-full border-collapse border border-gray-300" role="table" aria-label="Location information">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td className="border border-gray-300 px-4 py-2 text-sm">234 TEST ST</td>
              ...
              <section className="mb-8" aria-labelledby="receipt-info-heading">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label htmlFor="gross-retail-receipts" className="block text-sm font-medium text-gray-700 mb-2 bg-gray-100 p-2 rounded">
                      Gross Retail Receipts (Excluding Sales Tax) $
                    </label>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">$</span>
                      <input
                        id="gross-retail-receipts"
                        type="number"
                        step="0.01"
                        min="0"
                        value={formData.grossRetailReceipts}
                        onChange={(e) => handleInputChange('grossRetailReceipts', e.target.value)}
                        className="w-full pl-8 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#002B5B] focus:border-[#002B5B] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                        aria-describedby="gross-receipts-help"
                      />
                    </div>
                    <p id="gross-receipts-help" className="text-xs text-gray-600 mt-1">Enter amount in dollars and cents</p>
                  </div>

                  <div>
                    <label htmlFor="extended-stays" className="block text-sm font-medium text-gray-700 mb-2 bg-gray-100 p-2 rounded">
                      Extended Stays $
                    </label>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">$</span>
                      <input
                        ...
                        step="0.01"
                        min="0"
                        value={formData.extendedStays}
                        onChange={(e) => handleInputChange('extendedStays', e.target.value)}
                        className="w-full pl-8 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#002B5B] focus:border-[#002B5B] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                        aria-describedby="extended-stays-help"
                      />
                    </div>
                    <p id="extended-stays-help" className="text-xs text-gray-600 mt-1">Enter amount in dollars and cents</p>
                  </div>

                  <div>
                    <label htmlFor="government-exemptions" className="block text-sm font-medium text-gray-700 mb-2 bg-gray-100 p-2 rounded">
                      Government Exemptions $
                    </label>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">$</span>
                      <input
                        id="government-exemptions"
                        type="number"
                        step="0.01"
                        min="0"
                        value={formData.governmentExemptions}
                        onChange={(e) => handleInputChange('governmentExemptions', e.target.value)}
                        className="w-full pl-8 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#002B5B] focus:border-[#002B5B] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                        aria-describedby="government-exemptions-help"
                      />
                    </div>
                    <p id="government-exemptions-help" className="text-xs text-gray-600 mt-1">Enter amount in dollars and cents</p>
                  </div>

                  <div>
                    <label htmlFor="non-occupancy" className="block text-sm font-medium text-gray-700 mb-2 bg-gray-100 p-2 rounded">
                      Non-Occupancy $
                    </label>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-500">$</span>
                      <input
                        ...
                        step="0.01"
                        min="0"
                        value={formData.nonOccupancy}
                        onChange={(e) => handleInputChange('nonOccupancy', e.target.value)}
                        className="w-full pl-8 pr-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#002B5B] focus:border-[#002B5B] [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                        aria-describedby="non-occupancy-help"
                      />
                    </div>
                    <p id="non-occupancy-help" className="text-xs text-gray-600 mt-1">Enter amount in dollars and cents</p>
                  </div>
                </div>
              </section>
...
export default GrossReceiptReturnRoomOccupancy;